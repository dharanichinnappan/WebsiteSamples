...
<span class="crayon-o">=</span>
<span class="crayon-s">"index.css"</span>
<span class="crayon-o">></span>
</head>
<body>
	<center>
...
<tr>
  ...
  <tr>
		...
		<tr>
			<td><input required type="radio" name="userans"
				value="<?php echo $row['option 4'];?>">&nbsp;<?php echo $row['option 4']; ?><br>
			<br>
			<br></td>
		</tr>
		<tr>
 ...
 session_unset(); ?></span><br> <span>Your Score:&nbsp<?php echo $no*2; ?></span>
<?php } ?>
